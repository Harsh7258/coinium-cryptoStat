...
const HomePage = () => {
    ...
    // passing 10 to set value of count
    ...
    return (
        ...
        <Row>
            ...
            <Col span={12}> 
                <Statistic title='Total Markey Cap' value={millify(globalStats.totalMarketCap)} /> 
            </Col>
            <Col span={12}> 
        ...
        <div className='home-heading-container'>
            <Title level={4} className='home-title'>Top 10 Cryptocurrencies in the World
            </Title>
